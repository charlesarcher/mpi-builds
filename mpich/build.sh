...
OPTFLAGS_COMMON="-ggdb -O3 -DNDEBUG -fomit-frame-pointer -finline-functions -fno-strict-aliasing ${EXTRA_OPT}"
DEBUGFLAGS_COMMON="-ggdb -O0"
...
export OFIDIR=${PWD%/*}/install/${COMPILER}/ofi-${BUILD_TYPE}
