...
if [ ! "$2" ];then
    LIBRARY="debug-ofi-tg-noinline-ep-dynamic-dynamic-dynamic"
else
    LIBRARY=$2
fi
    ...
    case ${COUNT} in
        ...
        1)
		    ...
		    export FIRSTDEVICE=ofi
                    ...
                    ;;
                shm)
		    export FIRSTDEVICE=shm
                    export DEVICES=ch4
                    ;;
                am_ofi)
		    export FIRSTDEVICE=am_ofi
                    export DEVICES=ch4
                    ;;
                *)
                    echo "${OPTION}: Unknown ch4 type:  use stub|ofi"
                    exit 1
                    ;;
            esac
            ;;
        ...
        5)
		    ...
		    case ${FIRSTDEVICE} in
			stub)
			    export DEVICES="$DEVICES:stub,am_ofi,of,shm"
			    ;;
			ofi)
			    export DEVICES="$DEVICES:ofi,am_ofi,stub,shm"
			    ;;
			shm)
			    export DEVICES="$DEVICES:shm,am_ofi,ofi,stub"
			    ;;
			am_ofi)
			    export DEVICES="$DEVICES:am_ofi,shm,ofi,stub"
			    ;;
			*)
...
#DEVICES="${DEVICES}:amstub,stub,ofi"
DEVICES="${DEVICES}"
