...
export TASKS_PER_NODE_FULL=18
export TASKS_FULL=36
export TASKS_2=2
...
PLATFORMS="ch4_psm2 netmod_ofi_psm2 ompi_ofi_psm2 ompi_psm2 mvapich_psm2 impi_psm ompi_stock_psm2 mvapich_stock_psm2 ompi_ofi_opa ch4_opa"
...
MPIEXEC_FLAVORS=( ["mvapich_psm2"]="${BINDIR_BASE}/${COMPILER}/mvapich-optimized-psm2/bin/mpiexec.hydra"
		          ["mvapich_stock_psm2"]="/usr/mpi/gcc/mvapich2-2.1-hfi/bin/mpiexec.hydra"
                  ...
                  ["ompi_ofi_psm2"]="${BINDIR_BASE}/${COMPILER}/openmpi-optimized-psm2/bin/mpirun"
                  ["ompi_ofi_opa"]="${BINDIR_BASE}/${COMPILER}/openmpi-optimized-opa/bin/mpirun"
                  ["ompi_psm2"]="${BINDIR_BASE}/${COMPILER}/openmpi-optimized-psm2/bin/mpirun"
		          ["ompi_stock_psm2"]="/usr/mpi/gcc/openmpi-1.10.0-hfi/bin/mpirun"
...
BIND_FLAVORS=( ["mvapich_psm2"]="-bind-to core -map-by core -launcher ssh -hosts ${HOSTS}"
	           ["mvapich_stock_psm2"]="-bind-to core -map-by core -launcher ssh -hosts ${HOSTS}"
               ...
               ["ompi_psm2"]="--quiet --mca mtl psm2 --mca pml cm -host ${HOSTS} -x PSM_PKEY=0x8001 -x MXM_LOG_LEVEL=error --bind-to core --map-by core"
               ["ompi_ofi_psm2"]="--quiet --mca mtl ofi --mca pml cm -host ${HOSTS} -x MXM_LOG_LEVEL=error --bind-to core --map-by core"
               ["ompi_ofi_opa"]="--quiet --mca mtl ofi --mca pml cm -host ${HOSTS} -x MXM_LOG_LEVEL=error --bind-to core --map-by core"
	           ["ompi_stock_psm2"]="--quiet --mca mtl psm2 --mca pml cm -host ${HOSTS} -x PSM_PKEY=0x8001 -x MXM_LOG_LEVEL=error --bind-to core --map-by core"
...
BASEDIR_FLAVORS=( ["mvapich_psm2"]="${EXE_BASE}/${COMPILER}/mvapich_psm2/mpi"
		          ["mvapich_stock_psm2"]="${EXE_BASE}/${COMPILER}/mvapich_stock/mpi"
                  ["mvapich_ib"]="${EXE_BASE}/${COMPILER}/mvapich-ib/mpi"
                  ["netmod_ofi_base"]="${EXE_BASE}/${COMPILER}/netmod-ofi-base/mpi"
                  ["netmod_ofi_psm2"]="${EXE_BASE}/${COMPILER}/netmod_ofi_psm2/mpi"
                  ...
                  ["ompi_psm2"]="${EXE_BASE}/${COMPILER}/ompi_ofi_psm2/mpi/"
                  ["ompi_ofi_psm2"]="${EXE_BASE}/${COMPILER}/ompi_ofi_psm2/mpi/"
                  ["ompi_ofi_opa"]="${EXE_BASE}/${COMPILER}/ompi_ofi_opa/mpi/"
		          ["ompi_stock_psm2"]="${EXE_BASE}/${COMPILER}/ompi_stock/mpi/"
...
BENCHMARK_LIST=( ["mvapich_psm2"]="${BENCHMARKS}"
                 ...
                 ["ch4_psm2"]="${BENCHMARKS}"
                 ["ch4_opa"]="${BENCHMARKS}"
                 ["ompi_psm2"]="${BENCHMARKS_OMPI}"
                 ["ompi_ofi_psm2"]="${BENCHMARKS_OMPI}"
                 ["ompi_ofi_opa"]="${BENCHMARKS_OMPI}"
		         ["ompi_stock_psm2"]="${BENCHMARKS_OMPI}"
...
PRINT_RANK=( ["mvapich_psm2"]="-prepend-rank"
	         ["mvapich_stock_psm2"]="-prepend-rank"
             ...
             ["ompi_psm2"]="-tag-output"
             ["ompi_ofi_psm2"]="-tag-output"
             ["ompi_ofi_opa"]="-tag-output"
	         ["ompi_stock_psm2"]="-tag-output"
             ["ompi_mxm"]="-tag-output"
             ["ompi_ib"]="-tag-output"
